...
| **4.** | **PulseStream Backend**  | PulseStream is a high-performance real-time event ingestion, analytics, and alerting backend built on Bun. It ingests millions of small events, streams them over WebSockets, and is designed for benchmarking Bun. | Bun, Typescript, native HTTP server, WebSockets, workers, high concurrency | [![Readme](https://img.shields.io/badge/Readme-View%20Readme-blue)](https://github.com/ritulsingh/backend_collection/blob/main/PulseStream/README.md)   |
